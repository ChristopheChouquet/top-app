...
import UserInfos from "./UserInfosWall";



function RechercheGestionTops({searchValue}) {
...
useEffect(() => {
    ...
    const filteredTops = top.filter((top) => {
        ...
        return titreMatches || motCleMatches;
    });
...
return(
    <>
        <div id="home" className="flex flex-wrap justify-center mb-16 pt-10">
...
export default RechercheGestionTops ;
...
function ProfilEdit({datas}) {
    ...
    const onSubmit = function(data) {
        ...
        //On envoie le nouveau top au serveur si je veux faire une page externe
                        ...
                        <div className="flex relative mb-10">
                            ...
                            <div className="w-1/5 absolute z-10 left-0">
                                <label htmlFor="fileInput" className="fileInputLabel">
                                    <img 
                                        alt="preview" 
                                        src={imageselect ? imageselect : process.env.PUBLIC_URL + '/' + user.avatar}
                                ...
                                <input 
                                    ...
                                    /* onClick={() => {
                                        console.log('Image sélectionnée', imageselect);

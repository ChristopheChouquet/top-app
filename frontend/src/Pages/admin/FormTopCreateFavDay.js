...
function FormTopCreateFavDay({ datas }) {
   ...
   return(
        <div id="createTop" className='p-10 mb-14 h-screen'>
            ...
            <h1 className="text-3xl font-bold w-full text-center mt-4">Créer le Fav of the day</h1>
...
export default FormTopCreateFavDay;